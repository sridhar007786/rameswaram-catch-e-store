      ...
      <div className="pt-24 pb-20 min-h-screen bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h1 className="section-title text-foreground mb-4">{t('contact.title')}</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">{t('contact.hours_weekday')}<br />{t('contact.hours_sunday')}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-card rounded-2xl overflow-hidden shadow-ocean h-[500px] lg:h-auto">
              <iframe
                ...
                width="100%" height="100%" style={{ border: 0, minHeight: '400px' }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Meenava Sonthangal Location"
              />
            </div>
          </div>
        </div>
